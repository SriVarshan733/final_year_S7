            ...
            <img src="https://img.icons8.com/?size=512&id=ME2aFAiY2j6h&format=png" width="40px"  alt="Mountains">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=post_auction">Post Auction</a></li>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        ...
                        <a class="d-block" href="call:<?php echo $_SESSION['system']['contact'] ?>"><?php echo $_SESSION['system']['contact'] ?></a>
                    </div>
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        <i class="fas fa-users fa-3x mb-3 text-muted"></i>
                        <a class="d-block" href="call:<?php echo $_SESSION['system']['contact'] ?>"><?php echo "Customer support" ?></a>
                    </div>
