                ...
                <form action="" id="manage-product">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="farmer_id"
                                value="<?php echo isset($farmer_id) ? $farmer_id :'' ?>" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-4">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control text-right" name="regular_price"
                                value="<?php echo isset($regular_price) ? $regular_price : 0 ?>">
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control datetimepicker" name="bid_end_datetime"
                                value="<?php echo isset($bid_end_datetime) && strtotime($bid_end_datetime) > 0 ? date("Y-m-d H:i",strtotime($bid_end_datetime)) : '' ?>">
                        </div>
                    </div>
